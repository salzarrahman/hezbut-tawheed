        ...
        <div class="join-our-movement-title-block">
            <div class="section-title-block section-block-center">
                <h2 class="section-title">
                    <?php echo e(__('translate.ask_about_us')); ?>

                </h2>
                <p class="section-summary">
                    <?php echo e(__('translate.ask_about_us_description')); ?>
        ...
        <div style="" class="join-our-movement-wrapper">
            <div class="join-our-movement-form-block w-form">
                ...
                <div class="custom-submit-button">
                    <button id="askAboutus" class="custom-submit-button submit-button w-button"><?php echo e(__('Send')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH D:\xampp\htdocs\work.kroyhaat.com\resources\views/frontend/components/movement.blade.php ENDPATH**/ ?>