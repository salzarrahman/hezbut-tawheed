<style>
    ...
    /* End slider-section */
    .breadcrumb-section {
        background-image: url(<?php echo e(asset($setting->breadcrumb_bg ?? '')); ?>);
    }
    ...
    * {
    ...
    .footer {
        background-image: url(<?php echo e(asset($setting->footer_bg ?? '')); ?>);
    }
...
<?php /**PATH D:\xampp\htdocs\work.kroyhaat.com\resources\views/frontend/layouts/customcss.blade.php ENDPATH**/ ?>