            ...
            <div class="card-body">
              <div class="">
                <table class=" table table-bordered table-striped table-hover datatable desktop" style="width:100%">
                   ...
                   <tbody>
                    @foreach($askaboutus as $key=> $item)
                     <tr>
                        ...
                        <td class="text-center ">
                            ...
                            <a href="{{ route('admin.ask-about-us.show',$item->id) }}"class="btn btn-sm btn-outline-primary">
                                <i class="far fa-eye" aria-hidden="true"></i>
                            </a>

                            <a href="{{ route('admin.ask-about-us.sendemail',$item->id) }}"class="btn btn-sm btn-outline-primary">
                                <i class="far fa-envelope" aria-hidden="true"></i>
                            </a>

                            <a href="{{ route('admin.ask-about-us.destroy',$item->id) }}" class="btn btn-sm btn-outline-danger" id="delete">
