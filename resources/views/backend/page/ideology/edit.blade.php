...
@section('page-content')
    ...
    <form method="post" action="{{ route('admin.ideology.update') }}" enctype="multipart/form-data">
        @csrf

        <input type="hidden" name="id" value="{{ $ldeology->id }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row  g-md-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control  @error('title') is-invalid @enderror" value="{{ old('title' ,$ldeology->title) }}">
                                        @error('title')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea  class="ckeditor form-control @error('price') is-invalid @enderror" name="summary">{{ old('summary' ,$ldeology->summary) }}</textarea>
                                        @error('summary')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div><!-- end col -->
