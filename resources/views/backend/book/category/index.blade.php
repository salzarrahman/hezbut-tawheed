...
@section('page-content')
      ...
      <div class="card">
        <div class="card-header py-3">
          <h6 class="mb-0">Book Category</h6>
        </div>
        <div class="card-body">
           <div class="row">
             <div class="col-12 col-lg-4 d-flex">
               <div class="card border shadow-none w-100">
                 <div class="card-body">
                    <form id="myForm" method="post" action="{{ route('admin.book_category.store') }}">
                        @csrf
                      <div class="row g-3">
                        <div class="col-12">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class=" table table-bordered table-striped table-hover datatable desktop" style="width:100%">
                       ...
                       <tbody>
                        @foreach($book_category as $key=> $item)
                         <tr>
                           <td>#{{ $item->id }}</td>
                           <td>{{ $item->title }}</td>
                           <td>{{ $item->title_slug }}</td>
                           <td class="text-center">

                                <a href="{{ route('admin.book_category.edit',$item->id) }}"class="btn btn-sm btn-outline-primary">
                                    <i class="far fa-edit" aria-hidden="true"></i> Edit
                                </a>
                                <a href="{{ route('admin.book_category.destroy',$item->id) }}" class="btn btn-sm btn-outline-danger" id="delete">
