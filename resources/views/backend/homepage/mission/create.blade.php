    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="myForm" method="post" action="{{ route('admin.mission.store') }}" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            <div class="col-md-8">
                                <div class="border p-3 rounded">
                                    <div class="from-group mb-3">
                                        ...
                                        <input name="feature_title" id="feature_title" type="text" class="form-control">
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 rounded">
                                    <div class="form-group mb-3 text-center">
                                        <img id="showImage"src="" class="shadow " width="120" height="120" alt="" style="background-color: #16327a;">
                                    </div>
...
<script>
    ...
    $("#summary").on("input", function () {
        ...
        if ($(this).val().length < 100) {
            $("#slider_summary_noticeArea").html("Maximum 100 characters");
            $(".summary_sup").html("(maximum 5 words and 100 Character  )");
        }
    });
