        ...
        <div class="container">
            <div class="navbar-wrapper">
                ...
                <a href="/" aria-current="page" class="navbar-brand w-nav-brand w--current">
                    <img src="{{(!empty($setting->logo)) ? asset($setting->logo): url('upload/11.jpg') }}"oading="lazy" alt="Logo Image" class="logo-image" />
                </a>
